    ...
    <>
      <div className="bg-blue-900 h-1/2    ">
        ...
        <div className="grid gap-x-8 gap-y-4 lg:grid-cols-3 lg:pl-48 sm:grid-cols-1 justify-center">
          ...
          <div className="p-5">
            <ul>
              <li className=" text-white  text-2xl pb-4 hover:text-grey-800 cursor-pointer">
                Home
              </li>
              <li className="text-white text-2xl pb-4 hover:text-grey-800 cursor-pointer">
                Scholarships
          ...
          <div className="p-5">
            <p className="text-white  font-blod text-2xl pb-4 hover:text-grey-800 cursor-pointer">
              Find us
            </p>
            <ul className="flex">
