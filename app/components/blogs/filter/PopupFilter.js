...
function PopupFilter({ visible, onClose }) {
  ...
  const filterData = [
    {
      title: "Bachelor",
      items: ["Mathematics", "Management", "Business", "Computer Science"],
    },
    {
      title: "Masters",
      items: [
    ...
    },
    {
      ...
      items: ["Mathematics", "Medical", "Business", "Information Technology"],
    },
  ];

  if (!visible) return null;

  const handleFilteronClick = (item) => {
    handleFilter(item);
  };
  // useEffect(() => {
  //   filterItems();
                  ...
                  <div key={index} className="filter-col">
                    ...
                    <ul>
                      {column.items.map((item, itemIndex) => (
                        <li key={itemIndex}>
                          <a href="#" onClick={() => handleFilteronClick(item)}>
                            {item}
                          </a>
                        </li>
                      ))}
